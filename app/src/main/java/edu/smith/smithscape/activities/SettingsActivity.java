...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static void bindPreferenceSummaryToValue(Preference preference) {
        ...
        // current value.
        if(preference.getKey().equals("analytics_pref_key")) {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            String preference = getResources().getString(R.string.pref_campus_key);
    ...
    public static class AnalyticsPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            String preference = getResources().getString(R.string.pref_analytics_key);
            bindPreferenceSummaryToValue(findPreference(preference));
        }
